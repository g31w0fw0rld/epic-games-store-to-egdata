...
- **[PCGamingWiki](https://www.pcgamingwiki.com/)** — compatibility, fixes, ultrawide and frame-rate notes. It searches for **the game itself**: without the edition suffix and, whenever the offer belongs to a game — a DLC, an edition, a currency pack — by that game, which is where PCGamingWiki documents it.
...
- **[PCGamingWiki](https://www.pcgamingwiki.com/)** —compatibilidad, arreglos, ultrapanorámico y notas de frame rate—. Busca **el juego en sí**: sin el sufijo de edición y, siempre que la oferta pertenezca a un juego —un DLC, una edición, un paquete de monedas—, por ese juego, que es donde PCGamingWiki lo documenta.
