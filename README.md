...
- **[PCGamingWiki](https://www.pcgamingwiki.com/)** — compatibility, fixes, ultrawide and frame-rate notes. It searches for **the game itself**: without the edition suffix and, on a DLC, an edition or a bundle, by the game it belongs to, which is where PCGamingWiki documents it.
...
- **[PCGamingWiki](https://www.pcgamingwiki.com/)** —compatibilidad, arreglos, ultrapanorámico y notas de frame rate—. Busca **el juego en sí**: sin el sufijo de edición y, en un DLC, una edición o un bundle, por el juego al que pertenece, que es donde PCGamingWiki lo documenta.
