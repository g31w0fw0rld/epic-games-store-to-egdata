...
(function () {
    ...
    const I18N = {
        ...
        'es-419': {
            ...
            aboutBody: [
                ...
                '– EGData (base de datos de precios e historial de ofertas) enlaza a esa oferta concreta, no a una búsqueda.',
                '– GG.deals busca entre las ofertas con DRM de Epic, sin el mínimo de valoración de tienda que trae por defecto, y PCGamingWiki busca compatibilidad y arreglos. Los dos usan el nombre en inglés, pedido por el id de la oferta, porque Epic traduce los nombres de los juegos; y siempre que la oferta pertenezca a un juego —un DLC, una edición, un paquete de monedas—, PCGamingWiki busca ese juego. Cada uno lo avisa en su información emergente: busca por nombre y puede fallar.',
        ...
        ru: {
            ...
            aboutBody: [
                ...
                '– GG.deals ищет среди предложений с DRM Epic, без стандартного минимального рейтинга магазинов, а PCGamingWiki ищет совместимость и исправления. Оба используют английское название, полученное по id предложения, потому что Epic переводит названия игр; а если предложение относится к игре — DLC, издание, набор валюты — PCGamingWiki ищет эту игру. Каждый предупреждает в подсказке, что ищет по названию и может промахнуться.',
        ...
        uk: {
            ...
            aboutBody: [
                ...
                '– GG.deals шукає серед пропозицій із DRM Epic, без типового мінімального рейтингу магазинів, а PCGamingWiki шукає сумісність і виправлення. Обидва беруть англійську назву, отриману за id пропозиції, бо Epic перекладає назви ігор; а якщо пропозиція належить до гри — DLC, видання, набір валюти — PCGamingWiki шукає цю гру. Кожен попереджає у підказці, що шукає за назвою і може не влучити.',
        ...
        cs: {
            ...
            aboutBody: [
                ...
                '– GG.deals hledá mezi nabídkami s DRM Epicu, bez výchozího minimálního hodnocení obchodů, a PCGamingWiki hledá kompatibilitu a opravy. Oba používají anglický název, získaný podle id nabídky, protože Epic názvy her překládá; a pokud nabídka patří ke hře — DLC, edice, balíček měny — hledá PCGamingWiki tuto hru. Každý ve své bublině upozorňuje, že hledá podle názvu a nemusí trefit.',
        ...
        ro: {
            ...
            aboutBody: [
                ...
                '– GG.deals caută printre ofertele cu DRM Epic, fără pragul implicit de evaluare a magazinelor, iar PCGamingWiki caută compatibilitate și remedieri. Amândouă folosesc numele în engleză, cerut după id-ul ofertei, pentru că Epic traduce numele jocurilor; iar când oferta aparține unui joc — un DLC, o ediție, un pachet de monedă —, PCGamingWiki caută acel joc. Fiecare anunță în indiciul său că întreabă după nume și poate greși.',
        ...
        tr: {
            ...
            aboutBody: [
                ...
                '– GG.deals, Epic DRM\'li fırsatlar arasında, varsayılan asgari mağaza puanı olmadan arar; PCGamingWiki ise uyumluluk ve düzeltmeleri arar. İkisi de İngilizce adı kullanır — teklif kimliğiyle sorulur, çünkü Epic oyun adlarını çevirir — ve teklif bir oyuna aitse — DLC, sürüm, para paketi — PCGamingWiki o oyunu arar. Her biri ipucunda ada göre aradığını ve şaşabileceğini belirtir.',
        ...
        hi: {
            ...
            aboutBody: [
                ...
                '– GG.deals, Epic DRM वाले ऑफ़रों में खोजता है, बिना डिफ़ॉल्ट स्टोर-रेटिंग सीमा के, और PCGamingWiki संगतता तथा सुधार खोजता है। दोनों अंग्रेज़ी नाम इस्तेमाल करते हैं, जो ऑफ़र आईडी से लिया जाता है, क्योंकि Epic गेम के नाम अनुवाद करता है; और अगर ऑफ़र किसी गेम का हिस्सा है — DLC, एडिशन, करेंसी पैक — तो PCGamingWiki उसी गेम को खोजता है। हर बटन अपने टूलटिप में बताता है कि वह नाम से खोजता है और चूक सकता है।',
        ...
        ms: {
            ...
            aboutBody: [
                ...
                '– GG.deals mencari dalam tawaran ber-DRM Epic, tanpa ambang penilaian kedai lalai, dan PCGamingWiki mencari keserasian serta pembaikan. Kedua-duanya menggunakan nama Inggeris, diminta melalui id tawaran, kerana Epic menterjemah nama permainan; dan setiap kali tawaran ini milik sesebuah permainan — DLC, edisi, pek mata wang — PCGamingWiki mencari permainan itu. Setiap satu menyatakan dalam tooltip-nya bahawa ia mencari mengikut nama dan boleh tersasar.',
        ...
        th: {
            ...
            aboutBody: [
                ...
                '– GG.deals ค้นในดีลที่มี DRM ของ Epic โดยไม่ใช้เกณฑ์คะแนนร้านค้าขั้นต่ำที่ตั้งไว้ ส่วน PCGamingWiki ค้นเรื่องความเข้ากันได้และการแก้ไข ทั้งคู่ใช้ชื่อภาษาอังกฤษที่ขอมาด้วยรหัสข้อเสนอ เพราะ Epic แปลชื่อเกม และหากข้อเสนอนี้เป็นของเกมใดเกมหนึ่ง (DLC, รุ่น, แพ็กสกุลเงิน) PCGamingWiki จะค้นเกมนั้นแทน แต่ละปุ่มบอกไว้ในคำแนะนำแล้วว่าค้นด้วยชื่อจึงอาจไม่ตรง',
        ...
        ja: {
            ...
            aboutBody: [
                ...
                '– GG.deals は Epic の DRM が付いた特価の中を、既定の店舗評価の下限なしで検索します。PCGamingWiki は互換性と修正を検索します。どちらもオファー ID で取得した英語名を使います。Epic がゲーム名を翻訳するためです。オファーが何らかのゲームに属する場合（DLC、エディション、通貨パックなど）、PCGamingWiki はそのゲームを検索します。名前で検索するため外すことがある旨は、それぞれのツールチップに書いてあります。',
        ...
        ko: {
            ...
            aboutBody: [
                ...
                '– GG.deals는 Epic DRM이 걸린 할인 중에서, 기본 상점 평점 하한 없이 검색합니다. PCGamingWiki는 호환성과 수정을 검색합니다. 둘 다 오퍼 id로 받아온 영어 이름을 씁니다. Epic이 게임 이름을 번역하기 때문입니다. 그리고 오퍼가 어떤 게임에 속하면(DLC, 에디션, 화폐 팩 등) PCGamingWiki는 그 게임을 검색합니다. 이름으로 검색하므로 빗나갈 수 있다는 점은 각 버튼의 툴팁에 적혀 있습니다.',
        ...
        'zh-cn': {
            ...
            aboutBody: [
                ...
                '– GG.deals 在带 Epic DRM 的优惠中搜索，且不套用默认的店铺评分下限；PCGamingWiki 则搜索兼容性与修复。两者都使用英文名称，按报价 id 取得，因为 Epic 会翻译游戏名；若该报价隶属于某款游戏（DLC、版本、货币包等），PCGamingWiki 改为搜索那款游戏。两个按钮的提示里都写明了是按名称搜索，可能不准。',
        ...
        'zh-tw': {
            ...
            aboutBody: [
                ...
                '– GG.deals 在帶 Epic DRM 的優惠中搜尋，且不套用預設的商店評分下限；PCGamingWiki 則搜尋相容性與修正。兩者都使用英文名稱，依報價 id 取得，因為 Epic 會翻譯遊戲名稱；若該報價隸屬於某款遊戲（DLC、版本、貨幣包等），PCGamingWiki 改為搜尋那款遊戲。兩個按鈕的提示都寫明是以名稱搜尋，可能不準。',
     ...
     *     la oferta pertenece a un juego, el nombre de ese juego; null si no se pudo
     *     obtener.
     */
